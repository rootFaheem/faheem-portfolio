              ...
              <div className="text-center col-md-4 col-auto" id="bottom">
                <div className="text-justify bg-light" id="borderRadius">
                  ...
                  <div id="paddings">
                    ...
                    everything as problem to be solved. When I am not coding
                    then you will find me on twitter, watching The Big Bang
                    Theory or Mr. Robot. I do use twitter a lot. Twitter has
                    always been my source of my daily news. Why i love Twitter
                    because of its authenticity. I things i always fail in is
                    hit the zym daily.
                  </div>
                </div>
              </div>
              <div className="text-center col-md-4 col-auto" id="bottom">
                <div className="text-justify bg-light " id="borderRadius">
                  ...
                  <div id="paddings">
                    ...
                    GGSIPU for my Graduation. So, from GGSIPU I have completed
              ...
              <div className="text-center col-md-4 col-auto" id="bottom">
                <div className="text-justify bg-light" id="borderRadius">
                  ...
                  <div id="paddings">
                    ...
                    stuff i like is <strong>Elon Musk vision</strong>,
                    Blockchain, InfoSec. There are lot of entertainment stuff i
                    watch such as The Big Bang Theory, Mr. Robot, Silicon
                    Valley, Iron Man series. And i do resarch about random
                    things.
                  </div>
                </div>
              </div>
